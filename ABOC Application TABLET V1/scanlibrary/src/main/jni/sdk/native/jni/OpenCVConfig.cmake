...
if(ANDROID AND OpenCV_ANDROID_NATIVE_API_LEVEL GREATER ANDROID_NATIVE_API_LEVEL)
  chatMessage(FATAL_ERROR "Minimum required by OpenCV API level is android-${OpenCV_ANDROID_NATIVE_API_LEVEL}")
  ...
  elseif(NOT OpenCV_FIND_QUIETLY)
    chatMessage(WARNING "Minimum required by OpenCV API level is android-${OpenCV_ANDROID_NATIVE_API_LEVEL}")
  endif()
...
foreach(__cvcomponent ${OpenCV_FIND_COMPONENTS})
  ...
  if(__cvcomponentIdx LESS 0)
    ...
    if(OpenCV_FIND_REQUIRED)
      chatMessage(FATAL_ERROR "${__cvcomponent} is required but was not found")
    elseif(NOT OpenCV_FIND_QUIETLY)
      chatMessage(WARNING "${__cvcomponent} is required but was not found")
    endif()
  ...
  if(OpenCV_CUDA_VERSION)
    if(NOT CUDA_FOUND)
      ...
      if(NOT CUDA_VERSION_STRING VERSION_EQUAL OpenCV_CUDA_VERSION)
        chatMessage(FATAL_ERROR "OpenCV static library was compiled with CUDA ${OpenCV_CUDA_VERSION} support. Please, use the same version or rebuild OpenCV with CUDA ${CUDA_VERSION_STRING}")
      endif()
    endif()
...
macro(ocv_check_dependencies)
  ...
  foreach(d ${ARGN})
    if(NOT TARGET ${d})
      chatMessage(WARNING "OpenCV: Can't resolve dependency: ${d}")
